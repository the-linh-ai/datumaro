    ...
    def _load_items(self, path):
        ...
        with open(path) as f:
            for i, ann in enumerate(json.load(f)):
                ...
                annotations = [Points(points.tolist(),
                ...
                if joint_others:
                    ...
                    for i in range(num_others):
                        ...
                        annotations.append(Points(points.tolist(), vis.tolist(),
                            label=0, group=group_num, attributes=attributes))

                        group_num +=1

                items[item_id] = DatasetItem(id=item_id, subset=self._subset,
                    image=osp.join(root_dir, ann.get('img_paths', '')),
